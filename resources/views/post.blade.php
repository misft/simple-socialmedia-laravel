    ...
    <div class="container-fluid">
        <div class="col mt-3">
            <div class="col">
                ...
                <a href="{{$load[0]->post_id}}/{{$load[0]-> images}}"><img class="img-3  center-align"
            ...
            <div class="col">
                <form action="/post/{{$load[0]->post_id}}/commentpost" method="post">
                    ...
                    <div class="row">
                        <textarea name="comment" class="materialize-textarea col-10" placeholder="Comments"></textarea>
        ...
        <div class="col">
            ...
            <div class="row">
                <div class="col-3">
                <a href="/profile/{{$i->user_id}}"><img class="img-1 rounded-circle" src="{{asset($i->avatar)}}" alt=""></a>
                </div>
                <div class="col">
